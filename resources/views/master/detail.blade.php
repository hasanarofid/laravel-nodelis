      ...
      <div class="col-12">
            ...
            <div class="card-header pb-0 p-3">
                <div class="row">
                  <div class="col-6 d-flex align-items-center">
                    <h6 class="mb-0">Detail Master </h6>
                  </div>
                </div>
              </div>
        ...
        <div class="patient-card">
            <div class="patient-info">
                <h2>{{ $model->nama  }}</h2>
                <p><strong>Master Test:</strong> {{ !empty($model->masterTest->nama) ? $model->masterTest->nama : '-'  }}</p>
                <p><strong>Paket:</strong> {{ !empty($model->masterTest->paket->nama) ? $model->masterTest->paket->nama : '-'  }}</p>
