...
@section('subjudul','List Master')
@section('breadcrumbs')
<li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Dashboard</a></li>
<li class="breadcrumb-item text-sm text-white active" aria-current="page">Master</li>
        ...
        <div class="card mb-4">
            <div class="card-header pb-0 p-3">
                  ...
                  <div class="col-6 d-flex align-items-center">
                    <h6 class="mb-0">Tabel Master</h6>
                  </div>
                  <div class="col-6 text-end">
                    <a class="btn btn-sm bg-success text-white" href="{{ route('master.add') }}"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Tambah Master</a>
                  </div>
                </div>
              </div>
             ...
             <table class="table align-items-center table-primary  table-bordered" id="data-table">
                <thead>
                  <tr>
                    ...
                    <th class="text-uppercase text-xxs font-weight-bolder opacity-7">Master</th>
                    <th class="text-uppercase text-xxs font-weight-bolder opacity-7">Paket</th>
    ...
    jQuery(document).ready(function () {
      // alert(1);
        jQuery('#data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('master.list') }}", // Replace with your route
            columns: [
                 {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                { data: 'nama', name: 'nama' },
                { data: 'master_test', name: 'master_test' },
