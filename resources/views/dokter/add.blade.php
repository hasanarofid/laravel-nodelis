...
@section('subjudul','Add Dokter')
@section('breadcrumbs')
<li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Dashboard</a></li>
<li class="breadcrumb-item text-sm text-white active" aria-current="page">Add Dokter</li>
                ...
                <div class="mb-3">
                        ...
                        <label for="jenis" class="col-md-4 col-form-label "> Jenis Kelamin</label>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input  placeholder="specialist" type="text" class="form-control" id="specialist"  name="specialist"  >
                            </div>
                        </div>
