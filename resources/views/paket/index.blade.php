...
@section('title','Paket')
@section('subjudul','List Paket')
@section('breadcrumbs')
<li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Dashboard</a></li>
<li class="breadcrumb-item text-sm text-white active" aria-current="page">Paket</li>
        ...
        <div class="card mb-4">
            <div class="card-header pb-0 p-3">
                  ...
                  <div class="col-6 d-flex align-items-center">
                    <h6 class="mb-0">Tabel Paket</h6>
                  </div>
                  <div class="col-6 text-end">
                    <a class="btn btn-sm bg-success text-white" href="{{ route('paket.add') }}"><i class="fas fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;Tambah Paket</a>
                  </div>
                </div>
              </div>
    ...
    jQuery(document).ready(function () {
      // alert(1);
        jQuery('#data-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('paket.list') }}", // Replace with your route
            columns: [
